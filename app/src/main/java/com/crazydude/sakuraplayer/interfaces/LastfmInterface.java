...
public interface LastfmInterface {
    ...
    Observable<SessionResponse> login(@Field("username") String username,
    ...
    Observable<RecommendationsResponse> getRecommendedArtists(@Field("page") int page,
    ...
    Observable<ArtistInfoResponse> getArtistInfo(@Field("artist") String name,
    ...
    Observable<AlbumResponse> getNewReleases(@Field("user") String username,
                                             @Field("api_key") String apiKey);
}
